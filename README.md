...
[`passphrase-arcana.txt`](./passphrase-arcana.txt) contains 26,431 lowercase ASCII words, ready for use with `phraze`:
...
The scores for the 26,431 words in the final list range from a minimum of 1.25 to a median of 1.95 and a maximum of 2.5. Lower is easier to type. About 32% of words score below 1.8 (easy range), and 55% below 2.0.
...
For this list (26,431 words), each word in your passphrase counts for 14.7 bits of entropy. A 6-word passphrase provides:
...
| Mean word length                                        | 7.52 characters |
| [Entropy per word](#how-passphrase-entropy-works)       | 14.690 bits     |
| [Efficiency per character](#efficiency-per-character)   | 1.953 bits      |
| [Shortest edit distance](#edit-distance)                | 1               |
| [Mean edit distance](#edit-distance)                    | 7.092           |
